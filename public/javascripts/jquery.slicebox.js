...
;( function( $, window, undefined ) {
	...
	*/
	...
	$.fn.slicebox = function( options ) {
		...
		var self = $.data( this, 'slicebox' );//data() 方法向被选元素附加数据，或者从被选元素获取数据。
		
		if ( typeof options === 'string' ) {
			
			var args = Array.prototype.slice.call( arguments, 1 );//Array.prototype.slice.call(arguments)能将具有length属性的对象转成数组
